            ...
            ->children()
                ...
                ->arrayNode('sms')
                    ...
                    ->children()
                        ...
                        ->scalarNode('template')->defaultValue('SchebTwoFactorBundle:Authentication:form.html.twig')->end()
                        ->scalarNode('digits')->defaultValue(6)->end()
                        ->scalarNode('failOpen')->defaultFalse()->end()
                        ->scalarNode('errorTemplate')->defaultValue('SchebTwoFactorBundle:Authentication:error.html.twig')->end()
                        ->arrayNode('nexmo')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('username')->defaultNull()->end()
                                ->scalarNode('password')->defaultNull()->end()
                                ->scalarNode('fromNumber')->defaultNull()->end()
                            ->end()
                        ->end()
                    ->end()
                ->end()
